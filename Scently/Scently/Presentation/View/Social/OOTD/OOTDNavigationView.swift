...
protocol OOTDNavigationViewDelegate: AnyObject {
    func didTapBackButton()
    func didTapAlertButton()
}

final class OOTDNavigationView: UIView {
    
    weak var delegate: OOTDNavigationViewDelegate?
...
private extension OOTDNavigationView {
    func setupUI() {
