//
//  LikePerfumeViewController.swift
//  Scently
//
...
final class LikePerfumeViewController: UIViewController {
...
extension LikePerfumeViewController: UICollectionViewDelegate {
    
}

extension LikePerfumeViewController: UICollectionViewDataSource {
    func collectionView(
...
//        cell.configure(title: perfume.name, subTitle: perfume.brand,imageURL: perfume.imageURL)
        cell.configure(title: "Dior", subTitle: "디올 ", imageURL: "123")
...
extension LikePerfumeViewController {
